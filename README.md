# Tarefa de Programação Orientada a Objetos (Classe Estatica)
...
Este projeto foi pedido a utilização de Classe Estatica, sendo 1 Tarefas proposta pelo Professor.
...
* **Versão 1.1** - Inicio e Finalização do Projeto e Criação ReadMe *23/10/2024*
